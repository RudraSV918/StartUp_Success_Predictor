...
def show_prediction(prob_log,prob_knn,prob_rf,log_model,log_metrics,knn_metrics,rf_metrics,input_values):
    ...
    df_acc = pd.DataFrame({
        "Model": ["Logistic", "KNN", "Random Forest"],
        "Train Accuracy": [log_metrics["train_accuracy"], knn_metrics["train_accuracy"], rf_metrics["train_accuracy"]],
        "Test Accuracy": [log_metrics["test_accuracy"], knn_metrics["test_accuracy"], rf_metrics["test_accuracy"]]
    })
